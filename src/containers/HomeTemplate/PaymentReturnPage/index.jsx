        ...
        <>
          ...
          <div className="payment-success">
            ...
            <div className="transaction-info">
              ...
              <p><strong>Hình thức thanh toán:</strong> {data?.bankCode}</p>
              <p><strong>Nội dung:</strong> thanh toán cho đơn hàng {data?.bookingId}</p>
              <p><strong>Số tiền thanh toán:</strong> {data?.amount} VND</p>
            </div>
          </div>
        </>
      ) : (
        <>
          ...
          <div className="payment-fail">
            ...
            <div className="transaction-info">
              ...
              <p><strong>Mã lỗi:</strong> {data?.responseCode}</p>
              <p><strong>Vui lòng thử lại hoặc liên hệ hỗ trợ.</strong></p>
            </div>
          </div>
        </>
      )}
